"""Pre-seeded matter step content for demo matter."""

DEMO_STEP_CONTENT: dict[str, dict] = {
    "client_intake": {
        "fields": {
        ...
        "problemStatement": (
            "Client requires a senior employment agreement for incoming CFO with enhanced "
            "confidentiality, restrictive covenants, and variable remuneration aligned to KPIs."
        ),
        "goals": [
        ...
        "flags": [
            {
                "type": "gap",
                "severity": "medium",
                "message": "IP Assignment Policy not yet uploaded — required before draft finalisation.",
            },
            {
                "type": "consistency",
                "severity": "low",
                "message": "Offer email references 6-month notice; intake notes specify 3-month employee notice.",
            },
        ],
    },
    "legal_research": {
        "citations": [
            {
                ...
                "excerpt": "Non-compete clauses must be no wider than necessary to protect legitimate business interests.",
            },
            {
                "title": "Patel v Peninsula Business Services",
                "source": "EAT precedent",
                "excerpt": "Garden leave provisions upheld where employer continues salary during restricted period.",
            },
            {
                "title": "Employment Rights Act 1996 — s.86",
                "source": "Statute",
                "excerpt": "Minimum notice periods for employees with continuous service over one month.",
            },
        ],
        "summary": (
            "Research confirms enforceability of tailored restrictive covenants for senior executives "
            "when supported by legitimate interest and reasonable duration. Bonus clauses should specify "
            "objective metrics and pro-rata treatment on termination."
        ),
        "jurisdictionNotes": "England & Wales governing law; exclusive jurisdiction of English courts recommended.",
    },
    "strategy_structure": {
        "suggestions": [
            {
    ...
    "internal_review": {
        "complianceChecks": [
            ...
            {"rule": "Restrictive covenant reasonableness", "pass": True, "detail": "Duration and scope reviewed against Patel line of cases"},
            ...
            {"rule": "Data protection (employee monitoring)", "pass": False, "detail": "Add reference to employee privacy notice"},
        ],
        "comparisons": [
            {
                "left": "Prior CFO contract (2022)",
                "right": "Draft v1",
                "diffSummary": "Non-compete extended from 6 to 9 months; bonus metrics updated to EBITDA-based schedule.",
            }
        ],
    },
    "client_review": {
    ...
    "revision_negotiation": {
        "versions": [
            ...
            {"label": "v2", "date": "2026-05-15", "summary": "Incorporated pro-rata bonus; pending non-compete negotiation"},
        ],
        "comments": [
            {
